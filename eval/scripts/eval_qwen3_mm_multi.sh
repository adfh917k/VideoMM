...
CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes 1 --main_process_port 12341 -m lmms_eval \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix qwen3vl_8B_mm_multi_${max_num_frames}_budget_${tkn_budget} \
    --output_path ./logs_qwen3vl_mm_multi \
